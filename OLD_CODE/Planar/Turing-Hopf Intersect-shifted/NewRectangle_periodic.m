...
%%
 %create the video writer with 1 fps
  writerObj = VideoWriter('Turingfig11new.avi');
...
%% Use this section to create video after outputting data
for i=400:1:1800
   clf
   plt = trisurf(t(1:3,:)',p(1,:),p(2,:),U(1:np,i));
   axis tight
    shading interp
   colorbar
   caxis([0 1.8])
